...
//for a valid variance we def need a major and minor ele so like bbbb has 0 var bcz no minor present in this. now consider abbbb
    int largestVariance(string s) {

        int ans = 0;

        // Try every ordered pair (major, minor)
